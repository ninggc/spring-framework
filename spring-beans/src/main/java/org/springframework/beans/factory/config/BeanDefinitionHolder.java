...
/**
 * Holder for a BeanDefinition with name and aliases.	通过beanName和aliases持有BeanDefinition
 * Can be registered as a placeholder for an inner bean.	可以被注册为任何内部bean的占位符(?)
 *
